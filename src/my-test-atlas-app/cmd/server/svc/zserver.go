...
//
// TODO: Extend the MyTestAtlasApp service by defining new RPCs and
...
//
// TODO: Create an implementation of the MyTestAtlasApp server
...
// implementation of MyTestAtlasApp server interface service, but only
...
// Default implementation of the MyTestAtlasApp server interface
type server struct{}
...
func NewBasicServer() (pb.MyTestAtlasAppServer, error) {
	return &server{}, nil
}
